import "./team-risk-anxiety-trigger.css";
import bigAlert from "@assets/big-alert.svg";

export default function TeamRiskAnxietyTrigger() {
    return (
        <div className="team-risk-anxiety-trigger">
            ...
            <div className="diagram-footer-trigger">
                ...
                <div className="diagram-footer-text4">• Регулярно информировать команду об изменениях</div>
            </div>
        </div>
    );
}
