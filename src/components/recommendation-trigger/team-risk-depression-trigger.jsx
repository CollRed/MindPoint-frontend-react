import "./team-risk-depression-trigger.css";
import bigAlert from "@assets/big-alert.svg";

export default function TeamRiskDepressionTrigger() {
    return (
        <div className="team-risk-depression-trigger">
            ...
            <div className="diagram-footer-trigger">
                ...
                <div className="diagram-footer-text3">• Обсудить возможности развития и роста</div>
                <div className="diagram-footer-text4">• Поддержать чувство значимости вклада команды</div>
            </div>
        </div>
    );
}
