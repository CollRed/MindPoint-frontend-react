...
import "./depression-content.css";


export default function DepressionContent({ teams = [] }) {
    return (
        <>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.depression?.Normal?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.depression?.Normal?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.depression?.Normal?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.depression?.Mild?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.depression?.Mild?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.depression?.Mild?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.depression?.Moderate?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.depression?.Moderate?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.depression?.Moderate?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.depression?.High?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.depression?.High?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.depression?.High?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.depression?.Very_High?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.depression?.Very_High?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.depression?.Very_High?.percent || 0)}%</span>
                            </div>
                        </div>
                    </div>
                ))}
