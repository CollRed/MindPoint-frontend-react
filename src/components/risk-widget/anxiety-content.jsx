...
import "./anxiety-content.css";

export default function AnxietyContent({ teams = [] }) {
    return (
        <>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.anxiety?.Normal?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.anxiety?.Normal?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.anxiety?.Normal?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.anxiety?.Mild?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.anxiety?.Mild?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.anxiety?.Mild?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.anxiety?.Moderate?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.anxiety?.Moderate?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.anxiety?.Moderate?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.anxiety?.High?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.anxiety?.High?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.anxiety?.High?.percent || 0)}%</span>
                            </div>
                        </div>
                            ...
                            <div className="progress-risk">
                                <div className="progress-bar-base">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.round(team.anxiety?.Very_High?.percent || 0)}%`,
                                            minWidth:
                                                Math.round(team.anxiety?.Very_High?.percent || 0) === 0 ? '1px' : undefined,
                                        }}
                                    />
                                </div>
                                <span>{Math.round(team.anxiety?.Very_High?.percent || 0)}%</span>
                            </div>
                        </div>
                    </div>
                ))}
