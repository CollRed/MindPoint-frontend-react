...
import "./stress-chart.css";


export default function StressChart({ data = [], teamId, period }) {
    ...
    const buildSmoothPath = (values) => {
        ...
        const extendedPoints = [
            { x: linePadding, y: points[0].y },
            ...points,
            { x: chartWidth - linePadding, y: points[points.length - 1].y },
        ];
