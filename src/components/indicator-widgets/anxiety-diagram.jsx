...
import "./anxiety-diagram.css";


export default function AnxietyDiagram({ data }) {
    const normal = Math.round(data?.[0]?.anxiety?.Normal?.percent || 0);
    const mild = Math.round(data?.[0]?.anxiety?.Mild?.percent || 0);
    const moderate = Math.round(data?.[0]?.anxiety?.Moderate?.percent || 0);
    const high = Math.round(data?.[0]?.anxiety?.High?.percent || 0);
    const veryHigh = Math.round(data?.[0]?.anxiety?.Very_High?.percent || 0);
                    ...
                    <div className="stress-diagram-bar">
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.anxiety?.Normal?.members} чел</div>
                            </div>
                        </div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.anxiety?.Mild?.members} чел</div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.anxiety?.Moderate?.members} чел</div>
                            </div>
                        </div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.anxiety?.High?.members} чел</div>
                            </div>
                        </div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.anxiety?.Very_High?.members} чел</div>
                            </div>
                        </div>
                    </div>
