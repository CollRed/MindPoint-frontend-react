...
import "./stress-diagram.css";


export default function StressDiagram({ data } ) {
    const normal = Math.round(data?.[0]?.stress?.Normal?.percent || 0);
    const mild = Math.round(data?.[0]?.stress?.Mild?.percent || 0);
    const moderate = Math.round(data?.[0]?.stress?.Moderate?.percent || 0);
    const high = Math.round(data?.[0]?.stress?.High?.percent || 0);
    const veryHigh = Math.round(data?.[0]?.stress?.Very_High?.percent || 0);
                    ...
                    <div className="stress-diagram-bar">
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.stress?.Normal?.members} чел</div>
                            </div>
                        </div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.stress?.Mild?.members} чел</div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.stress?.Moderate?.members} чел</div>
                            </div>
                        </div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.stress?.High?.members} чел</div>
                            </div>
                        </div>
                        ...
                        <div className="stress-bar-wrap">
                            ...
                            >
                                ...
                                <div className="bar-value">{data?.[0]?.stress?.Very_High?.members} чел</div>
                            </div>
                        </div>
                    </div>
